 ...
 * @file     lpuart.h
 * @version  V3.00
 * @brief    M2L31 series LPUART Interface Controller (LPUART) driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
/* LPUART AUTOCTL constants definitions                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define LPUART_AUTOCTL_TRIGSEL_LPTMR0   (0x0UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is LPTMR0 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_LPTMR1   (0x1UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is LPTMR1 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_TTMR0    (0x2UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is TTMR0 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_TTMR1    (0x3UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is TTMR1 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_WKIOA0   (0x4UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is WKIOA0 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_WKIOB0   (0x5UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is WKIOB0 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_WKIOC0   (0x6UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is WKIOC0 \hideinitializer */
#define LPUART_AUTOCTL_TRIGSEL_WKIOD0   (0x7UL << LPUART_AUTOCTL_TRIGSEL_Pos) /*!< LPUART Automatic Operation Trigger Source Select is WKIOD0 \hideinitializer */
 ...
 *    @return       None
 *
 *    @details      This macro disable specified LPUART interrupt.
 *    \hideinitializer
 */
