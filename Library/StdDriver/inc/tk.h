...
#define TK_SCAN_MODE_PERIODIC               (TK_SCANC_TRG_EN_Msk)                             /*!< Touch key periodic scan mode */
...
#define TK_TRG_EN_DISABLED                  (0UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction disabled */
#define TK_TRG_EN_TMR0                      (1UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction Timer0 */
#define TK_TRG_EN_TMR1                      (2UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction Timer1 */
#define TK_TRG_EN_TMR2                      (3UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction Timer2 */
#define TK_TRG_EN_TMR3                      (4UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction Timer3 */
#define TK_TRG_EN_RTC                       (5UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction RTC */
#define TK_TRG_EN_LPTMR0                    (8UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction LP Timer0 */
#define TK_TRG_EN_LPTMR1                    (9UL << TK_SCANC_TMRTRG_EN_Pos)      /*!< Touch key periodic trigger source selction LP Timer1 */
#define TK_TRG_EN_TICKTMR0                  (0xAUL << TK_SCANC_TMRTRG_EN_Pos)    /*!< Touch key periodic trigger source selction Tick Timer0 */
#define TK_TRG_EN_TICKTMR1                  (0xBUL << TK_SCANC_TMRTRG_EN_Pos)    /*!< Touch key periodic trigger source selction Tick Timer1 */
...
/**
 * @brief Get touch key sensing result data.
 * @param[in] u32TKNum Touch key number. The valid value is 17~25.
 * @return Sensing result data
 * \hideinitializer
 */
...
#define TK_INITIAL_POTENTIAL_GND             (0UL << TK_POLC_POL_INIT_Pos)
#define TK_INITIAL_POTENTIAL_AVDDH                   (1UL << TK_POLC_POL_INIT_Pos)
/**
 * @brief Set TK Sensing Initial Potential Level
 * @param[in] u32Level Sensing Initial Potential Level.
 *              - \ref TK_INITIAL_POTENTIAL_GND
 *              - \ref TK_INITIAL_POTENTIAL_AVDDH
 * @return None
 * \hideinitializer
 */
