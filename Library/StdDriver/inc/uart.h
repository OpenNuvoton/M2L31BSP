 ...
 * @file     uart.h
 * @version  V3.00
 * @brief    M2L31 series UART driver header file
 *
...
#define UART6_FIFO_SIZE 16ul /*!< UART6 supports separated receive/transmit 16/16 bytes entry FIFO \hideinitializer */
#define UART7_FIFO_SIZE 16ul /*!< UART7 supports separated receive/transmit 16/16 bytes entry FIFO \hideinitializer */
