 ...
 * @file     dac.h
 * @version V1.00
 * @brief    M2L31 series DAC driver header file
 *
...
#define DAC_PWM0_TRIGGER           ((8UL<<DAC_CTL_TRGSEL_Pos)|DAC_CTL_TRGEN_Msk)   /*!< EPWM0 trigger \hideinitializer */
#define DAC_PWM1_TRIGGER           ((9UL<<DAC_CTL_TRGSEL_Pos)|DAC_CTL_TRGEN_Msk)   /*!< EPWM1 trigger \hideinitializer */
