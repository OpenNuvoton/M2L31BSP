 ...
 * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
 * |[6]     |VBSNEBEN  |UTCPD0 VBUS Sink Disable As Edge-detect Brake Source (Write Protect)
 * |        |          |0 = UTCPD0 VBUS sink disable as edge-detect brake source Disabled.
 * |        |          |1 = UTCPD0 VBUS sink disable as edge-detect brake source Enabled.
 ...
 * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
 * |[14]    |VBSNLBEN  |UTCPD0 VBUS Sink Disable As Level-detect Brake Source (Write Protect)
 * |        |          |0 = UTCPD0 VBUS sink disable as level-detect brake source Disabled.
 * |        |          |1 = UTCPD0 VBUS sink disable as level-detect brake source Enabled.
 * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
 ...
 * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
 * |[23]    |VBSREBEN  |UTCPD0 VBUS Source Disable As Edge-detect Brake Source (Write Protect)
 * |        |          |0 = UTCPD0 VBUS source disable as edge-detect brake source Disabled.
 * |        |          |1 = UTCPD0 VBUS source disable as edge-detect brake source Enabled.
 * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
 ...
 * |        |          |0 = UTCPD0 VBUS source disable as level-detect brake source Disabled.
 * |        |          |1 = UTCPD0 VBUS source disable as level-detect brake source Enabled.
 * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
 * @var PWM_T::BRKCTL2_3
 ...
 * |        |          |10 = Synchronous start source come from PWM0.
 * |        |          |11 = Synchronous start source come from PWM1.
 * @var PWM_T::SSTRG
 ...
 * @var PWM_T::IFACNT[6]
 * Offset: 0x368  PWM Interrupt Flag Accumulator Counter 0/2/4
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
...
#define PWM_BRKCTL0_1_CPO2EBEN_Pos       (2)                                               /*!< PWM_T::BRKCTL0_1: CPO2EBEN Position    */
#define PWM_BRKCTL0_1_CPO2EBEN_Msk       (0x1ul << PWM_BRKCTL0_1_CPO2EBEN_Pos)             /*!< PWM_T::BRKCTL0_1: CPO2EBEN Mask        */
...
#define PWM_BRKCTL0_1_VBSNEBEN_Pos       (6)                                               /*!< PWM_T::BRKCTL0_1: VBSNEBEN Position    */
#define PWM_BRKCTL0_1_VBSNEBEN_Msk       (0x1ul << PWM_BRKCTL0_1_VBSNEBEN_Pos)             /*!< PWM_T::BRKCTL0_1: VBSNEBEN Mask        */
...
#define PWM_BRKCTL0_1_CPO2LBEN_Pos       (10)                                              /*!< PWM_T::BRKCTL0_1: CPO2LBEN Position    */
#define PWM_BRKCTL0_1_CPO2LBEN_Msk       (0x1ul << PWM_BRKCTL0_1_CPO2LBEN_Pos)             /*!< PWM_T::BRKCTL0_1: CPO2LBEN Mask        */
...
#define PWM_BRKCTL0_1_VBSREBEN_Pos       (23)                                              /*!< PWM_T::BRKCTL0_1: VBSREBEN Position    */
#define PWM_BRKCTL0_1_VBSREBEN_Msk       (0x1ul << PWM_BRKCTL0_1_VBSREBEN_Pos)             /*!< PWM_T::BRKCTL0_1: VBSREBEN Mask        */
...
#define PWM_BRKCTL0_1_VBSRLBEN_Pos       (31)                                              /*!< PWM_T::BRKCTL0_1: VBSRLBEN Position    */
#define PWM_BRKCTL0_1_VBSRLBEN_Msk       (0x1ul << PWM_BRKCTL0_1_VBSRLBEN_Pos)             /*!< PWM_T::BRKCTL0_1: VBSRLBEN Mask        */
...
#define PWM_BRKCTL2_3_CPO2EBEN_Pos       (2)                                               /*!< PWM_T::BRKCTL2_3: CPO2EBEN Position    */
#define PWM_BRKCTL2_3_CPO2EBEN_Msk       (0x1ul << PWM_BRKCTL2_3_CPO2EBEN_Pos)             /*!< PWM_T::BRKCTL2_3: CPO2EBEN Mask        */
...
#define PWM_BRKCTL2_3_VBSNEBEN_Pos       (6)                                               /*!< PWM_T::BRKCTL2_3: VBSNEBEN Position    */
#define PWM_BRKCTL2_3_VBSNEBEN_Msk       (0x1ul << PWM_BRKCTL2_3_VBSNEBEN_Pos)             /*!< PWM_T::BRKCTL2_3: VBSNEBEN Mask        */
...
#define PWM_BRKCTL2_3_CPO2LBEN_Pos       (10)                                              /*!< PWM_T::BRKCTL2_3: CPO2LBEN Position    */
#define PWM_BRKCTL2_3_CPO2LBEN_Msk       (0x1ul << PWM_BRKCTL2_3_CPO2LBEN_Pos)             /*!< PWM_T::BRKCTL2_3: CPO2LBEN Mask        */
...
#define PWM_BRKCTL2_3_VBSREBEN_Pos       (23)                                              /*!< PWM_T::BRKCTL2_3: VBSREBEN Position    */
#define PWM_BRKCTL2_3_VBSREBEN_Msk       (0x1ul << PWM_BRKCTL2_3_VBSREBEN_Pos)             /*!< PWM_T::BRKCTL2_3: VBSREBEN Mask        */
...
#define PWM_BRKCTL2_3_VBSRLBEN_Pos       (31)                                              /*!< PWM_T::BRKCTL2_3: VBSRLBEN Position    */
#define PWM_BRKCTL2_3_VBSRLBEN_Msk       (0x1ul << PWM_BRKCTL2_3_VBSRLBEN_Pos)             /*!< PWM_T::BRKCTL2_3: VBSRLBEN Mask        */
...
#define PWM_BRKCTL4_5_CPO2EBEN_Pos       (2)                                               /*!< PWM_T::BRKCTL4_5: CPO2EBEN Position    */
#define PWM_BRKCTL4_5_CPO2EBEN_Msk       (0x1ul << PWM_BRKCTL4_5_CPO2EBEN_Pos)             /*!< PWM_T::BRKCTL4_5: CPO2EBEN Mask        */
...
#define PWM_BRKCTL4_5_VBSNEBEN_Pos       (6)                                               /*!< PWM_T::BRKCTL4_5: VBSNEBEN Position    */
#define PWM_BRKCTL4_5_VBSNEBEN_Msk       (0x1ul << PWM_BRKCTL4_5_VBSNEBEN_Pos)             /*!< PWM_T::BRKCTL4_5: VBSNEBEN Mask        */
...
#define PWM_BRKCTL4_5_CPO2LBEN_Pos       (10)                                              /*!< PWM_T::BRKCTL4_5: CPO2LBEN Position    */
#define PWM_BRKCTL4_5_CPO2LBEN_Msk       (0x1ul << PWM_BRKCTL4_5_CPO2LBEN_Pos)             /*!< PWM_T::BRKCTL4_5: CPO2LBEN Mask        */
...
#define PWM_BRKCTL4_5_VBSREBEN_Pos       (23)                                              /*!< PWM_T::BRKCTL4_5: VBSREBEN Position    */
#define PWM_BRKCTL4_5_VBSREBEN_Msk       (0x1ul << PWM_BRKCTL4_5_VBSREBEN_Pos)             /*!< PWM_T::BRKCTL4_5: VBSREBEN Mask        */
...
#define PWM_BRKCTL4_5_VBSRLBEN_Pos       (31)                                              /*!< PWM_T::BRKCTL4_5: VBSRLBEN Position    */
#define PWM_BRKCTL4_5_VBSRLBEN_Msk       (0x1ul << PWM_BRKCTL4_5_VBSRLBEN_Pos)             /*!< PWM_T::BRKCTL4_5: VBSRLBEN Mask        */
...
#define PWM_STATUS_LPADCTRG_Pos          (23)                                              /*!< PWM_T::STATUS: LPADCTRG Position       */
#define PWM_STATUS_LPADCTRG_Msk          (0x1ul << PWM_STATUS_LPADCTRG_Pos)                /*!< PWM_T::STATUS: LPADCTRG Mask           */
