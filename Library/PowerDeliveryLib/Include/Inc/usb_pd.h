...
/* supported call back function */
typedef enum pd_callback
{
    PD_GET_SRC_CAPS,            /* To get port partner SRC Caps */
    PD_GET_SNK_CAPS,      /* To get port partner SRC Caps */
} CB_PD_E;
...
//#ifdef SW_2 /* SW Add to replace TASK_EVENT_WAKE on tcpci.c
#define TASK_EVENT_WAKE         (29)
//#endif /* SW_2 */
...
enum pd_dpm_request
{
    ...
    /* SW Add */
    DPM_REQUEST_FR_SWAP = BIT(23),
    DPM_REQUEST_PPS_REQUEST = BIT(24),      //CONFIG_SNK_PPS
    /* SW Add */
 ...
 *
 * Ref: TGL PDG
 * 3.1: Fiberweave Impact for HSIOs Operating at ?? GT/s Speeds
