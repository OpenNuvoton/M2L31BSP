...
#endif /* !defined(CHROMIUM_EC) && !defined(__KERNEL__) */
...
#else
    uint8_t rand[1];        /**< generated random numbers */
#endif
} __ec_align4;
...
//#ifdef SW /* Move to usb_pd_tcpm.h */
enum ec_bus_type
{
    EC_BUS_TYPE_I2C = 0,
...
/* SW Add {*/
#define PDO_FIXED_UNCHUNKED_EXTENDED_MESSAGE   BIT(24) /* Src only */
#define PDO_FIXED_EPR_MODE_CAPABLE             BIT(23) /* Src only */
/* SW Add }*/
