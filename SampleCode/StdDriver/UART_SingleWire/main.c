...
void SYS_Init(void)
{
    ...
    /* Set PA multi-function pins for UART0 TXD, RXD */
    SYS->GPA_MFP0 = (SYS->GPA_MFP0 & ~(SYS_GPA_MFP0_PA0MFP_Msk)) | SYS_GPA_MFP0_PA0MFP_UART0_RXD;
...
void UART_FunctionTest()
{
    ...
    printf("|    Single Wire 1(PA0)send data to Single Wire 2(PB0).     |\n");
    printf("|    Single Wire 2(PB0)send data to Single Wire 1(PA0).     |\n");
    printf("|    Please enter any to start    (Press '0' to exit)       |\n");
    printf("+-----------------------------------------------------------+\n");

    /*
        Using a RS232 cable to connect UART0 and PC.UART0 is set to debug port.
          UART0 and UART2 is enable RDA and RLS interrupt.
          The user can use URT0 to control the transmission or reception of UART0(Single Wire mode)
        When UART0(Single Wire 1)transfers data to UART2(Single Wire 2), if data is valid,
          it will enter the interrupt and receive the data.And then check the received data.
        When UART2(Single Wire 2)transfers data to UART0(Single Wire 1), if data is valid,
          it will enter the interrupt and receive the data.And then check the received data.
      */
    ...
    do
    {
        ...
        printf("+--------------------------------------------------------------+\n");
        printf("|    (1)Single Wire 1(PA0)send data to Single Wire 2(PB0).     |\n");
        printf("|    (2)Single Wire 2(PB0)send data to Single Wire 1(PA0).     |\n");
        printf("|    (E)Exit                                                   |\n");
        printf("+--------------------------------------------------------------+\n");
        ...
        case '1':
        {
            printf("SW1(UART0) --> SW2(UART2)Test :");
            g_i32RecOK  = FALSE;
        ...
        case '2':
        {
            printf("SW2(UART2) --> SW1(UART0)Test :");
            g_i32RecOK  = FALSE;
            Build_Src_Pattern((uint32_t)g_u8TxData, UART_WORD_LEN_8, BUFSIZE);
