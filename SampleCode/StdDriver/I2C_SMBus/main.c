...
void SYS_Init(void)
{
    ...
    SYS->GPA_MFP0 = (SYS->GPA_MFP0 & ~(SYS_GPA_MFP0_PA2MFP_Msk | SYS_GPA_MFP0_PA3MFP_Msk)) |
                    (SYS_GPA_MFP0_PA2MFP_I2C0_SMBSUS | SYS_GPA_MFP0_PA3MFP_I2C0_SMBAL);

    /* Set I2C1 multi-function pins */
    SYS->GPB_MFP2 = (SYS->GPB_MFP2 & ~(SYS_GPB_MFP2_PB10MFP_Msk | SYS_GPB_MFP2_PB11MFP_Msk)) |
                    (SYS_GPB_MFP2_PB10MFP_I2C1_SDA | SYS_GPB_MFP2_PB11MFP_I2C1_SCL);
    SYS->GPH_MFP2 = (SYS->GPH_MFP2 & ~(SYS_GPH_MFP2_PH8MFP_Msk | SYS_GPH_MFP2_PH9MFP_Msk)) |
                    (SYS_GPH_MFP2_PH8MFP_I2C1_SMBAL | SYS_GPH_MFP2_PH9MFP_I2C1_SMBSUS);
