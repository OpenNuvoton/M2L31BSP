...
//    "<SUB>              (SNK Only)               5V                  \n"
    ...
    "<EPERMR>\n"        /* Enable Periodic Message Request      */
    "<DPERMR>\n"        /* Disable Periodic Message Request     */
    "\n\n"
};
...
//                              break;
            ...
            break;
            case EPERMR:
                printf("Enable Periodic Message Request\n");
                bIsPeriodicRequest = 1;
                break;
            case DPERMR:
                printf("Disable Periodic Message Request\n");
                bIsPeriodicRequest = 0;
                break;
