...
void EADC_Init(void)
{
    ...
    EADC_ConfigSampleModule(EADC, 0, EADC_TIMER1_TRIGGER, 2);
    EADC_SetExtendSampleTime(EADC, 0, 0x80);

    /* Configure the sample module 1 for analog input channel 3 and timer0 trigger source.*/
    EADC_ConfigSampleModule(EADC, 1, EADC_TIMER1_TRIGGER, 3);
    EADC_SetExtendSampleTime(EADC, 1, 0x80);
    ...
    EADC_ENABLE_INT(EADC, BIT1);                    //Enable sample module 1 ADINT0 interrupt.
    ...
    EADC_ENABLE_INT(EADC, BIT2);                    //Enable sample module 2 ADINT0 interrupt.
    EADC_ENABLE_SAMPLE_MODULE_INT(EADC, 2, BIT2);   //Enable sample module 2 interrupt.
